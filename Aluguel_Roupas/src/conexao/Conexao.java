...
public class Conexao {
    ...
    final private String url = "jdbc:mysql://localhost/aluguel";
    ...
    public boolean conecta() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,"Driver não localizado" +Driver,"Mensgem do Programa", JOptionPane.INFORMATION_MESSAGE);
            result = false;                     
